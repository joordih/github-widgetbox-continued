...
function skillsWidget(languagesString, frameworksString, librariesString, toolsString, softwareString, includeNames, themeString) {
    ...
    xmlns="http://www.w3.org/2000/svg">
        ...
        ? 'none'
        : 'block'}" id="languages" transform="translate(0 ${FIRST_ROW})" fill="${theme.subtitle}" font-size="24" font-family="Roboto-Regular, Roboto, sans-serif">
                <tspan x="0" y="0">Languages</tspan>
            </text>
            <text style="display:${frameworkList.length <= 1 && frameworkList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="frameworks" transform="translate(0 ${frameworkTitleHeight})" fill="${theme.subtitle}" font-size="24" font-family="Roboto-Regular, Roboto, sans-serif">
                <tspan x="0" y="0">Frameworks</tspan>
            </text>
            <text style="display:${libraryList.length <= 1 && libraryList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="libraries" transform="translate(0 ${libraryTitleHeight})" fill="${theme.subtitle}" font-size="24" font-family="Roboto-Regular, Roboto, sans-serif">
                <tspan x="0" y="0">Libraries</tspan>
            </text>
            <text style="display:${toolsList.length <= 1 && toolsList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="tools" transform="translate(0 ${toolsTitleHeight})" fill="${theme.subtitle}" font-size="24" font-family="Roboto-Regular, Roboto, sans-serif">
                <tspan x="0" y="0">Tools</tspan>
            </text>
            <text style="display:${softwareList.length <= 1 && softwareList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="software" transform="translate(0 ${softwareTitleHeight})" fill="${theme.subtitle}" font-size="24" font-family="Roboto-Regular, Roboto, sans-serif">
                <tspan x="0" y="0">Software</tspan>
            </text>
        </g>
        <g style="display:${languageList.length <= 1 && languageList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="boxes" transform="translate(60 190)">
            ${getBoxes(languageList, 1)}
        </g>
        <g style="display:${frameworkList.length <= 1 && frameworkList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="boxes" transform="translate(60 ${frameworkTitleHeight + 100})">
            ${getBoxes(frameworkList, 2)}
        </g>
        <g style="display:${libraryList.length <= 1 && libraryList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="boxes" transform="translate(60 ${libraryTitleHeight + 100})">
            ${getBoxes(libraryList, 3)}
        </g>
        <g style="display:${toolsList.length <= 1 && toolsList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="boxes" transform="translate(60 ${toolsTitleHeight + 100})">
            ${getBoxes(toolsList, 4)}
        </g>
        <g style="display:${softwareList.length <= 1 && softwareList[0] === 'undefined'
        ? 'none'
        : 'block'}" id="boxes" transform="translate(60 ${softwareTitleHeight + 100})">
